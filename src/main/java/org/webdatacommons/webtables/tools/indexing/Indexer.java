package org.webdatacommons.webtables.tools.indexing;
...
import org.webdatacommons.webtables.tools.typing.Types;
...
public class Indexer extends WebreduceIterator {
	...
	// activate preprocessing (analysis of title, terms and, column typing,
	...
	public static void main(String[] args) throws IOException,
		...
		jsap.registerParameter(new Switch(STORE_FULL_RESULT_IN_LEVELDB)
				.setLongFlag(STORE_FULL_RESULT_IN_LEVELDB).setShortFlag('l'));
	...
	protected void processDataset(Dataset er) throws IOException {
		...
		doc.add(new StringField("tableType", er.getTableType().name(),
				Field.Store.YES));
	...
	protected String preprocess(
			org.webdatacommons.webtables.tools.data.Dataset ds) {
